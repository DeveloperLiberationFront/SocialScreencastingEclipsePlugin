...
public class RotatingFileManager {
	...
	public void makeNextFile() throws IOException 
	{
		...
		System.out.println("Rotating file manager changing to file "+newFile);
	...
	public void stop()
	{
		if (currentFileStream != null)
		{
			...
			{
				System.err.println("Rotating file manager Problem closing fileStream");
				e.printStackTrace();
			}
	...
	public static class DefaultListener implements RotatingFileManagerListener
	{
		...
		private String padIntTo4Digits(int i)
		{
			if (i<0)
			{
				System.err.println("Who put a negative here? "+i);
